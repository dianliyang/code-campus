        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-8">
              <span className="text-[10px] font-black text-brand-blue uppercase tracking-[0.2em]">System Architecture</span>
            </div>
            
            <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter mb-8 leading-tight">
              The Central Index <br /> for <span className="text-brand-blue">CS Curricula</span>.
            </h2>
            
            <div className="space-y-6 text-gray-400 font-medium text-lg leading-relaxed max-w-xl">
              <p>
                CodeCampus is a specialized search engine that indexes public course catalogs from the world&apos;s top universities, creating a unified schema for comparison.
              </p>
              <p>
                We don&apos;t host content. Instead, we structure scattered data—prerequisites, difficulty ratings, and syllabi—into a single, queryable knowledge graph to help you build your own learning roadmap.
              </p>
            </div>
            ...
            <div className="mt-12 flex flex-wrap gap-12">
              <div>
                ...
                <div className="text-[10px] uppercase tracking-[0.3em] font-bold text-gray-500">Sources</div>
              </div>
              <div>
                <div className="text-4xl font-black text-white mb-1">2.4k</div>
                <div className="text-[10px] uppercase tracking-[0.3em] font-bold text-gray-500">Nodes</div>
              </div>
              <div>
                <div className="text-4xl font-black text-white mb-1">0xFC</div>
                <div className="text-[10px] uppercase tracking-[0.3em] font-bold text-gray-500">Schema</div>
              </div>
            </div>
          </div>

  ...
  return (
    <div className="space-y-4">
      <section className="rounded-lg border border-[#e5e5e5] bg-[#fcfcfc] p-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0">
            ...
            <h1 className="mt-1 text-xl font-semibold text-[#1f1f1f] break-words">{data.title}</h1>
          </div>
          <div className="flex flex-wrap items-center gap-2">
            {data.url ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex h-8 items-center justify-center gap-1.5 rounded-md border border-[#d3d3d3] bg-white px-2.5 text-[13px] font-medium text-[#3b3b3b] hover:bg-[#f8f8f8] transition-colors"
              >
                Open Source
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2 rounded-lg border border-[#e5e5e5] bg-[#fcfcfc] p-4 space-y-4">
          <ProjectSeminarContentsPanel projectSeminarId={data.id} initialContents={contents} />

          <div>
            <h2 className="text-sm font-semibold text-[#2a2a2a] mb-2">Prerequisites / Organisational information</h2>
            <p className="text-sm text-[#444] whitespace-pre-wrap leading-relaxed">{prereqOrg}</p>
          </div>

          <div>
            <h2 className="text-sm font-semibold text-[#2a2a2a] mb-2">Schedule</h2>
        ...
        <aside className="rounded-lg border border-[#e5e5e5] bg-[#fcfcfc] p-4">
          <h2 className="text-sm font-semibold text-[#2a2a2a] mb-3">Facts</h2>
          ...
          <div className="mt-4 border-t border-[#e9e9e9] pt-4">
            <h3 className="text-sm font-semibold text-[#2a2a2a] mb-2">Related Links</h3>

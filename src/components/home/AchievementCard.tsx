    ...
    <div className="bg-white border border-[#e5e5e5] p-3 flex flex-col gap-3 h-full relative rounded-md">
      ...
      <div className="mt-1">
        {(course.gpa || course.score || (course.attendance && course.attendance.total > 0) || course.credit) ? (
          <div className="grid grid-cols-4 gap-px bg-gray-50 border border-gray-50 rounded-lg overflow-hidden">
            <div className="bg-white py-2 flex flex-col items-center justify-center">
              ...
              <span className="text-xs font-black text-gray-900 italic">{course.credit || "—"}</span>
            </div>
            ...
            <div className="bg-white py-2 flex flex-col items-center justify-center border-l border-gray-50">
              ...
              <span className="text-xs font-black text-gray-900 italic">{course.score ? `${Number(course.score).toFixed(0)}%` : "—"}</span>
            </div>
            <div className="bg-white py-2 flex flex-col items-center justify-center border-l border-gray-50">
              <span className="text-[6px] font-bold text-gray-300 uppercase tracking-widest mb-0.5">ATTND</span>
              <span className="text-xs font-black text-gray-900 italic">{attendanceRate}%</span>
            </div>
          </div>
        ) : (
          <div className="bg-gray-50 py-3 rounded-lg border border-dashed border-gray-100 flex items-center justify-center">
      ...
      <div className="flex items-center justify-between pt-2 mt-auto border-t border-gray-50">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="w-6 h-6 rounded-md border border-gray-50 text-gray-300 hover:text-brand-blue hover:bg-blue-50 transition-all flex items-center justify-center"
          >
          ...
          <button
            ...
            className="w-6 h-6 rounded-md border border-gray-50 text-gray-300 hover:text-red-500 hover:bg-red-50 transition-all flex items-center justify-center disabled:opacity-50"
          >

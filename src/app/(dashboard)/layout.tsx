    ...
    <>
      <main className="h-[100dvh] bg-[#f5f5f5] overflow-hidden">
        <div className="h-full flex overflow-hidden">
          ...
          />
          <section className="flex-1 min-w-0 h-full overflow-y-auto p-1.5 pt-4 sm:p-2">
            <div className="h-full rounded-lg bg-[#fcfcfc] px-2 pt-4 pb-[calc(env(safe-area-inset-bottom,0px)+76px)] sm:px-3 sm:pt-3 sm:pb-3 overflow-y-auto">
              {children}
            </div>
          </section>
        </div>

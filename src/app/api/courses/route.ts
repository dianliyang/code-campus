...
async function fetchCourses(
  ...
  const modernSelectString = `
    id, university, course_code, title, units, url, details, instructors, prerequisites, resources, cross_listed_courses, department, level, difficulty, popularity, workload, subdomain, is_hidden, is_internal, created_at,
    fields:course_fields(fields(name)),
    semesters:course_semesters(semesters(term, year))
  `;
  const legacySelectString = `
    id, university, course_code, title, units, url, details, department, level, difficulty, popularity, workload, subdomain, is_hidden, is_internal, created_at,
    fields:course_fields(fields(name)),
    semesters:course_semesters(semesters(term, year))
  `;

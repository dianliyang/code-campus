        ...
        <div className="flex justify-between items-center h-16 lg:h-20">
          ...
          <div className="flex items-center">
            <Link href="/" className="group flex items-center gap-2 lg:gap-3">
              <div className="relative w-8 h-8 lg:w-10 lg:h-10 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-105">
                <Image
              ...
              <div className="flex flex-col -space-y-1">
                <span className="text-base lg:text-xl font-black tracking-tighter text-gray-900 uppercase leading-none">CodeCampus</span>
                <span className="hidden sm:block text-[8px] lg:text-[9px] font-black text-brand-blue uppercase tracking-[0.3em] opacity-80 group-hover:opacity-100 transition-opacity">

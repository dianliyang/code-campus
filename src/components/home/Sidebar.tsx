...
export default function Sidebar({ universities, fields, semesters, enrolledCount, dict }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside className="absolute inset-x-0 bottom-0 max-h-[86vh] overflow-y-auto rounded-t-2xl bg-white px-4 pt-4 pb-0 shadow-xl md:inset-y-0 md:right-0 md:left-auto md:w-[320px] md:max-h-none md:rounded-none md:border-l md:border-slate-200 md:py-4">

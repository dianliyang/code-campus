...
export default function CourseList({ 
  ...
  return (
    <main className="flex-grow space-y-4 min-w-0">
      ...
      <div className={viewMode === "grid" ? "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8" : "bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm"}>

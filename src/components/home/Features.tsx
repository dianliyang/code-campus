        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <Card key={idx}>
              <CardContent className="pt-6">
                <div className="w-10 sm:w-12 h-10 sm:h-12 bg-slate-100 flex items-center justify-center text-slate-400 mb-5 transition-colors duration-300 group-hover:bg-brand-blue/10 group-hover:text-brand-blue">
